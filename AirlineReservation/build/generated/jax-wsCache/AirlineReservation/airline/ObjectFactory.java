...
public class ObjectFactory {
    ...
    private final static QName _CancelFlight_QNAME = new QName("http://airline/", "cancelFlight");
    private final static QName _GetFlights_QNAME = new QName("http://airline/", "getFlights");
    private final static QName _BookFlightResponse_QNAME = new QName("http://airline/", "bookFlightResponse");
    private final static QName _GetFlightsResponse_QNAME = new QName("http://airline/", "getFlightsResponse");
    private final static QName _BookFlight_QNAME = new QName("http://airline/", "bookFlight");
    private final static QName _CancelFlightResponse_QNAME = new QName("http://airline/", "cancelFlightResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://airline/", name = "cancelFlight")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://airline/", name = "getFlights")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://airline/", name = "bookFlightResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://airline/", name = "getFlightsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://airline/", name = "bookFlight")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://airline/", name = "cancelFlightResponse")
